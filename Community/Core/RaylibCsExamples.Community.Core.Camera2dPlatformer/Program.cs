...
namespace RaylibCsExamples.Community.Core.Camera2dPlatformer;
...
public class Program
{
    ...
    public static int Main()
    {
        ...
        var cameraUpdaters = new CameraUpdaterCallback[]
        {
            UpdateCameraCenter,
        ...
        var cameraOption = 0;
        var cameraUpdatersLength = cameraUpdaters.Length;

        var cameraDescriptions = new string[]{
